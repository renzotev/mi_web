...
<div class="image-buttons">
    <div class="container">
        <a href="#" class="col-sm-6">
            <figure>
                <img src="img/img-btn-1.jpg" class="img-responsive hidden">
                <figcaption>
        ...
        <a href="#" class="col-sm-6">
            <figure>
                <img src="img/img-btn-2.jpg" class="img-responsive hidden">
                <figcaption>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="tab-consejos">
                    <div class="col-sm-3 img-consejo">
                        <img src="img/consejo-1.jpg" class="img-responsive">
                    </div>
                    <div class="col-sm-3 img-consejo">
                       <img src="img/consejo-2.jpg" class="img-responsive">
                    </div>

                    <div class="col-sm-3 img-consejo">
                        <img src="img/consejo-3.jpg" class="img-responsive">
                    </div>
                    <div class="col-sm-3 img-consejo">
                      <img src="img/consejo-4.jpg" class="img-responsive">
                    </div>
...
<div class="carousel-wrapper hidden">
    <div class="container">
        <div class="owl-carousel">
            <div class="item">
                <a href="#"><img src="img/item-carousel.jpg" class="img-responsive" /></a>
            </div>
            <div class="item">
                <a href="#"><img src="img/item-carousel.jpg" class="img-responsive" /></a>
            </div>
    ...
    <div class="container">
        <div class="col-sm-8">
            ...
            <div class="video-container">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/h4gAYCHTw48" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <div class="col-sm-4">
...
<div class="sponsors hidden">
    <div class="container">
        <img src="img/sponsors.jpg" class="img-responsive">
    </div>
</div>
